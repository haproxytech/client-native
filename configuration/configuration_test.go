...
frontend test
  mode http
  backlog 2048
  bind 192.168.1.1:80 name webserv thread all ocsp-update on sigalgs RSA+SHA256 client-sigalgs ECDSA+SHA256:RSA+SHA256
...
backend test
  ...
  server webserv 192.168.1.1:9200 maxconn 1000 ssl weight 10 inter 2s cookie BLAH slowstart 6000 proxy-v2-options authority,crc32c ws h1 pool-low-conn 128 id 1234 pool-purge-delay 10s
