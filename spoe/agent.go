...
func (c *SingleSpoe) GetAgent(scope, name, transactionID string) (int64, *models.SpoeAgent, error) {
	p, err := c.GetParser(transactionID)
	if err != nil {
		return 0, nil, err
	}
...
func (c *SingleSpoe) createEditAgent(scope string, data *models.SpoeAgent, t string, transactionID string, p *spoe.Parser) error {
	if data == nil {
