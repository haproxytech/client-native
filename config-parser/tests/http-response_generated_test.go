...
func TestResponseshttp(t *testing.T) {
	tests := map[string]bool{
		...
		"http-response add-headers-bin var(txn.oldheaders)":                                                                         true,
		"http-response add-headers-bin var(txn.oldheaders) prefix x-":                                                               true,
		"http-response del-headers-bin var(txn.oldheaders)":                                                                         true,
		"http-response del-headers-bin var(txn.oldheaders) -m beg":                                                                  true,
		"http-response set-headers-bin var(txn.oldheaders)":                                                                         true,
		"http-response set-headers-bin var(txn.oldheaders) prefix x-":                                                               true,
		...
		"http-response pause 20":                                                                                                    true,
		"http-response pause 20s":                                                                                                   true,
		"http-response pause res.hdr(X-Pause-Seconds),mul(1000)":                                                                    true,
		"http-response pause 20 if TRUE":                                                                                            true,
		"http-response pause 20s if TRUE":                                                                                           true,
		"http-response pause %[calc((sc_conn_rate(0) - 30) * 10)] if { sc_conn_rate(0) gt 30 }":                                     true,
		...
		"http-response add-headers-bin":                                            false,
		"http-response del-headers-bin":                                            false,
		"http-response set-headers-bin":                                            false,
