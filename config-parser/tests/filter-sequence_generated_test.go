...
func TestFilterSequence(t *testing.T) {
	tests := map[string]bool{
		"filter-sequence request lua.my-filter,comp-req":  true,
		"filter-sequence response lua.my-filter,comp-res": true,
		"filter-sequence":              false,
		"filter-sequence request":      false,
		"filter-sequence bogus filter": false,
		"---":                          false,
		"--- ---":                      false,
	}
	parser := &parsers.FilterSequence{}
