...
func TestHashPreserveAffinity(t *testing.T) {
	tests := map[string]bool{
		"hash-preserve-affinity always":            true,
		"hash-preserve-affinity maxconn # comment": true,
		"hash-preserve-affinity maxqueue":          true,
		"hash-preserve-affinity":                   false,
		"hash-preserve-affinity notvalid":          false,
		"---":                                      false,
		"--- ---":                                  false,
	}
	parser := &parsers.HashPreserveAffinity{}
