...
func TestForceBeSwitch(t *testing.T) {
	tests := map[string]bool{
		"force-be-switch if acl-name":     true,
		"force-be-switch unless acl-name": true,
		"force-be-switch":                 false,
		"force-be-switch if":              false,
		"force-be-switch ddd acl-name":    false,
		"force-be-switch acl-name":        false,
		"---":                             false,
		"--- ---":                         false,
	}
	parser := &parsers.ForceBeSwitch{}
