...
func TestTypePgsqlCheck(t *testing.T) {
	tests := map[string]bool{
		"type pgsql-check user john":           true,
		"type pgsql-check user john # comment": true,
		"type pgsql-check":                     false,
		"type pgsql-check # comment":           false,
		"type pgsql-check user":                false,
		"type pgsql-check user # comment":      false,
		"---":                                  false,
		"--- ---":                              false,
	}
	parser := &parsers.TypePgsqlCheck{}
