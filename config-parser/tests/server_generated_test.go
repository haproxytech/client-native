...
func TestServer(t *testing.T) {
	tests := map[string]bool{
		...
		"server name 127.0.0.1 check-reuse-pool":                              true,
		"server name 127.0.0.1 no-check-reuse-pool":                           true,
		"server name 127.0.0.1 check-pool-conn-name foo":                      true,
		"server name 127.0.0.1 strict-maxconn":                                true,
		"server name 127.0.0.1 tcp-md5sig secretpass":                         true,
		"server name 127.0.0.1 sni-auto":                                      true,
		"server name 127.0.0.1 no-sni-auto":                                   true,
		"server name 127.0.0.1 check-sni-auto":                                true,
		"server name 127.0.0.1 no-check-sni-auto":                             true,
		"server name 127.0.0.1 ktls on":                                       true,
		"server name 127.0.0.1 ktls off":                                      true,
		"server addr":                                                         false,
		"server name 127.0.0.1 idle-ping":                                     false,
		"server name 127.0.0.1 check-pool-conn-name":                          false,
		"server":                               false,
		"server name 127.0.0.1 log-bufsize":    false,
		"server name 127.0.0.1 tcp-md5sig":     false,
		"server name 127.0.0.1 ktls":           false,
		"server name 127.0.0.1 ktls something": false,
		"---":                                  false,
		"--- ---":                              false,
	}
