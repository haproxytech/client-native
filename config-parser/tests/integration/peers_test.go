...
func TestWholeConfigsSectionsPeers(t *testing.T) {
	...
	tests := []struct {
		...
		{"peers_defaultbindktlsoff", peers_defaultbindktlsoff},
		{"peers_defaultbindktlson", peers_defaultbindktlson},
		...
		{"peers_defaultserverchecksniauto", peers_defaultserverchecksniauto},
		...
		{"peers_defaultservernochecksniauto", peers_defaultservernochecksniauto},
		...
		{"peers_defaultservernosniauto", peers_defaultservernosniauto},
		...
		{"peers_defaultserversniauto", peers_defaultserversniauto},
