...
func TestRequestshttp(t *testing.T) {
	tests := map[string]bool{
		...
		"http-request add-headers-bin var(txn.oldheaders)":                                                                         true,
		"http-request add-headers-bin var(txn.oldheaders) prefix x-":                                                               true,
		"http-request add-headers-bin var(txn.oldheaders) prefix x- if TRUE":                                                       true,
		"http-request del-headers-bin var(txn.oldheaders)":                                                                         true,
		"http-request del-headers-bin var(txn.oldheaders) -m beg":                                                                  true,
		"http-request del-headers-bin var(txn.oldheaders) -m beg if TRUE":                                                          true,
		"http-request set-headers-bin var(txn.oldheaders)":                                                                         true,
		"http-request set-headers-bin var(txn.oldheaders) prefix x-":                                                               true,
		...
		"http-request pause 20":                                                                                                    true,
		"http-request pause 20s":                                                                                                   true,
		"http-request pause res.hdr(X-Pause-Seconds),mul(1000)":                                                                    true,
		"http-request pause 20 if TRUE":                                                                                            true,
		"http-request pause 20s if TRUE":                                                                                           true,
		"http-request pause %[calc((sc_conn_rate(0) - 30) * 10)] if { sc_conn_rate(0) gt 30 }":                                     true,
		...
		"http-request add-headers-bin":                                            false,
		"http-request del-headers-bin":                                            false,
		"http-request set-headers-bin":                                            false,
