...
func TestAfterResponseshttp(t *testing.T) {
	tests := map[string]bool{
		...
		"http-after-response add-headers-bin var(txn.oldheaders)":                            true,
		"http-after-response add-headers-bin var(txn.oldheaders) prefix x-":                  true,
		"http-after-response del-headers-bin var(txn.oldheaders)":                            true,
		"http-after-response del-headers-bin var(txn.oldheaders) -m beg":                     true,
		"http-after-response set-headers-bin var(txn.oldheaders)":                            true,
		"http-after-response set-headers-bin var(txn.oldheaders) prefix x-":                  true,
		...
		"http-after-response add-headers-bin":                                                false,
		"http-after-response del-headers-bin":                                                false,
		"http-after-response set-headers-bin":                                                false,
