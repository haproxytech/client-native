...
func TestStatsCalculateMaxCounters(t *testing.T) {
	tests := map[string]bool{
		"stats calculate-max-counters on":    true,
		"stats calculate-max-counters off":   true,
		"stats calculate-max-counters":       false,
		"stats calculate-max-counters bogus": false,
		"---":                                false,
		"--- ---":                            false,
	}
	parser := &parsers.StatsCalculateMaxCounters{}
