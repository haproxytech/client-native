...
func TestCompressionMinsizeRes(t *testing.T) {
	tests := map[string]bool{
		"compression minsize-res 10k": true,
		"compression minsize-res 10":  true,
		"compression minsize-res":     false,
		"---":                         false,
		"--- ---":                     false,
	}
	parser := &parsers.CompressionMinsizeRes{}
