...
func TestMaxThreadsPerGroup(t *testing.T) {
	tests := map[string]bool{
		"max-threads-per-group 32":     true,
		"max-threads-per-group":        false,
		"max-threads-per-group string": false,
		"---":                          false,
		"--- ---":                      false,
	}
	parser := &parsers.MaxThreadsPerGroup{}
