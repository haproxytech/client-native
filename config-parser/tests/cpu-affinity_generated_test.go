...
func TestCPUAffinity(t *testing.T) {
	tests := map[string]bool{
		"cpu-affinity per-core":        true,
		"cpu-affinity per-group":       true,
		"cpu-affinity per-group auto":  true,
		"cpu-affinity per-group loose": true,
		"cpu-affinity auto":            true,
		"cpu-affinity per-thread":      true,
		"cpu-affinity per-ccx":         true,
		"cpu-affinity":                 false,
		"---":                          false,
		"--- ---":                      false,
	}
	parser := &parsers.CPUAffinity{}
