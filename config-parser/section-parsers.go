...
func (p *configParser) getDefaultParser() *Parsers {
	...
	addParser(parser, &sequence, &parsers.OptionUseSmallBuffers{})
	...
	addParser(parser, &sequence, &parsers.OptionForwarded{})
	...
	addParser(parser, &sequence, &parsers.CompressionMinsizeReq{})
	addParser(parser, &sequence, &parsers.CompressionMinsizeRes{})
...
func (p *configParser) getGlobalParser() *Parsers { //nolint: maintidx
	...
	addParser(parser, &sequence, &parsers.MaxThreadsPerGroup{})
	addParser(parser, &sequence, &parsers.CPUMap{})
	addParser(parser, &sequence, &parsers.CPUAffinity{})
	...
	addParser(parser, &sequence, &parsers.StatsCalculateMaxCounters{})
	...
	addParser(parser, &sequence, &simple.String{Name: "ssl-passphrase-cmd"})
	...
	addParser(parser, &sequence, &simple.Enabled{Name: "no-memory-trimming"})
...
func (p *configParser) getFrontendParser() *Parsers {
	...
	addParser(parser, &sequence, &parsers.FilterSequence{})
	addParser(parser, &sequence, &parsers.CompressionAlgo{})
	addParser(parser, &sequence, &parsers.CompressionAlgoReq{})
	addParser(parser, &sequence, &parsers.CompressionAlgoRes{})
	addParser(parser, &sequence, &parsers.CompressionType{})
