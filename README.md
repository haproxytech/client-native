...
models can be generated with [generate_models.sh](generate_models.sh) script. It automatically combines specification parts into a single file, and then use that to generate models.
