...
func (x ACLFilesEntries) Diff(y ACLFilesEntries) map[string][]interface{} {
	return DiffACLFilesEntries(x, y)
}

func DiffACLFilesEntries(x, y ACLFilesEntries) map[string][]interface{} {
...
func DiffPointerACLFileEntry(x, y *ACLFileEntry) map[string][]interface{} {
	diff := make(map[string][]interface{})
	if x == nil && y == nil {
		return diff
	}
