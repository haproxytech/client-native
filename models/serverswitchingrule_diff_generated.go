...
func (rec ServerSwitchingRule) Diff(obj ServerSwitchingRule) map[string][]interface{} {
	...
	if rec.TargetServer != obj.TargetServer {
		diff["TargetServer"] = []interface{}{rec.TargetServer, obj.TargetServer}
	}
	return diff
}
