...
func (rec HealthCheckBase) Equal(obj HealthCheckBase, opts ...eqdiff.GoMethodGenOptions) bool {
	return EqualPointerHttpchkParams(rec.HttpchkParams, obj.HttpchkParams, opts...) &&
