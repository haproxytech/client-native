...
func (rec Errorfiles) Diff(obj Errorfiles) map[string][]interface{} {
	diff := make(map[string][]interface{})
	for diffKey, diffValue := range DiffSliceInt64(rec.Codes, obj.Codes) {
...
func DiffSliceInt64(x, y []int64) map[string][]interface{} {
	diff := make(map[string][]interface{})
	lenX := len(x)
	lenY := len(y)
