...
func (rec HTTPRequestRule) Diff(obj HTTPRequestRule) map[string][]interface{} {
	...
	if rec.AuthRealm != obj.AuthRealm {
		diff["AuthRealm"] = []interface{}{rec.AuthRealm, obj.AuthRealm}
	}
	...
	for diffKey, diffValue := range DiffPointerInt64(rec.DenyStatus, obj.DenyStatus) {
	...
	if rec.HintFormat != obj.HintFormat {
		diff["HintFormat"] = []interface{}{rec.HintFormat, obj.HintFormat}
	}
	if rec.HintName != obj.HintName {
		diff["HintName"] = []interface{}{rec.HintName, obj.HintName}
	}
	...
	if rec.MethodFmt != obj.MethodFmt {
		diff["MethodFmt"] = []interface{}{rec.MethodFmt, obj.MethodFmt}
	}
	if rec.NiceValue != obj.NiceValue {
		diff["NiceValue"] = []interface{}{rec.NiceValue, obj.NiceValue}
	}
	if rec.Normalizer != obj.Normalizer {
		diff["Normalizer"] = []interface{}{rec.Normalizer, obj.Normalizer}
	}
	if rec.NormalizerFull != obj.NormalizerFull {
		diff["NormalizerFull"] = []interface{}{rec.NormalizerFull, obj.NormalizerFull}
	}
	if rec.NormalizerStrict != obj.NormalizerStrict {
		diff["NormalizerStrict"] = []interface{}{rec.NormalizerStrict, obj.NormalizerStrict}
	}
	if rec.PathFmt != obj.PathFmt {
		diff["PathFmt"] = []interface{}{rec.PathFmt, obj.PathFmt}
	}
	if rec.PathMatch != obj.PathMatch {
		diff["PathMatch"] = []interface{}{rec.PathMatch, obj.PathMatch}
	}
	if rec.Protocol != obj.Protocol {
		diff["Protocol"] = []interface{}{rec.Protocol, obj.Protocol}
	}
	if rec.QueryFmt != obj.QueryFmt {
		diff["QueryFmt"] = []interface{}{rec.QueryFmt, obj.QueryFmt}
	}
	for diffKey, diffValue := range DiffPointerInt64(rec.RedirCode, obj.RedirCode) {
	...
	for diffKey, diffValue := range DiffPointerInt64(rec.ReturnStatusCode, obj.ReturnStatusCode) {
	...
	for diffKey, diffValue := range DiffPointerInt64(rec.TrackScStickCounter, obj.TrackScStickCounter) {
	...
	if rec.URIFmt != obj.URIFmt {
		diff["URIFmt"] = []interface{}{rec.URIFmt, obj.URIFmt}
	}
	if rec.URIMatch != obj.URIMatch {
		diff["URIMatch"] = []interface{}{rec.URIMatch, obj.URIMatch}
	}
	...
	for diffKey, diffValue := range DiffPointerInt64(rec.WaitAtLeast, obj.WaitAtLeast) {
		diff["WaitAtLeast."+diffKey] = diffValue
	}
	for diffKey, diffValue := range DiffPointerInt64(rec.WaitTime, obj.WaitTime) {
