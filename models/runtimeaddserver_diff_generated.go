...
func (rec RuntimeAddServer) Diff(obj RuntimeAddServer) map[string][]interface{} {
	...
	for diffKey, diffValue := range DiffPointerInt64(rec.ErrorLimit, obj.ErrorLimit) {
		diff["ErrorLimit."+diffKey] = diffValue
	}
