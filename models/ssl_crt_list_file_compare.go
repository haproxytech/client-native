...
// Equal checks if two structs of type SslCrtListFile are equal
//
//	var a, b SslCrtListFile
//	equal := a.Equal(b)
//
// opts ...Options are ignored in this method
func (s SslCrtListFile) Equal(t SslCrtListFile, opts ...Options) bool {
...
// Diff checks if two structs of type SslCrtListFile are equal
//
//	var a, b SslCrtListFile
//	diff := a.Diff(b)
//
// opts ...Options are ignored in this method
func (s SslCrtListFile) Diff(t SslCrtListFile, opts ...Options) map[string][]interface{} {
