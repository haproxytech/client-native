...
func (rec InfoSystemMemInfo) Diff(obj InfoSystemMemInfo, opts ...eqdiff.GoMethodGenOptions) map[string][]interface{} {
	...
	if rec.FreeMemory != obj.FreeMemory {
		diff["FreeMemory"] = []interface{}{rec.FreeMemory, obj.FreeMemory}
	}
	if rec.TotalMemory != obj.TotalMemory {
		diff["TotalMemory"] = []interface{}{rec.TotalMemory, obj.TotalMemory}
	}
	return diff
}
