...
func (m *MailersSectionBase) validateName(formats strfmt.Registry) error {
...
func (m *MailersSectionBase) validateTimeout(formats strfmt.Registry) error {
