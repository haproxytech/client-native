...
func TestWurflOptionsEqual(t *testing.T) {
	samples := []struct {
		a, b WurflOptions
	}{}
	for i := 0; i < 2; i++ {
		var sample WurflOptions
...
func TestWurflOptionsEqualFalse(t *testing.T) {
	samples := []struct {
		a, b WurflOptions
	}{}
	for i := 0; i < 2; i++ {
...
func TestWurflOptionsDiff(t *testing.T) {
	samples := []struct {
		a, b WurflOptions
	}{}
	for i := 0; i < 2; i++ {
...
func TestWurflOptionsDiffFalse(t *testing.T) {
	samples := []struct {
		a, b WurflOptions
	}{}
	for i := 0; i < 2; i++ {
