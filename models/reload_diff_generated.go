...
func (rec Reload) Diff(obj Reload) map[string][]interface{} {
	...
	if rec.ReloadTimestamp != obj.ReloadTimestamp {
		diff["ReloadTimestamp"] = []interface{}{rec.ReloadTimestamp, obj.ReloadTimestamp}
	}
	if rec.Response != obj.Response {
		diff["Response"] = []interface{}{rec.Response, obj.Response}
	}
