...
func (m *DefaultsBase) validateForwarded(formats strfmt.Registry) error {
...
func (m *DefaultsBase) contextValidateForwarded(ctx context.Context, formats strfmt.Registry) error {
