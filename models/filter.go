...
type Filter struct {
	...
	// type
	// Required: true
	// Enum: ["bwlim-in","bwlim-out","cache","compression","comp-req","comp-res","fcgi-app","spoe","trace","lua"]
	// +kubebuilder:validation:Enum=bwlim-in;bwlim-out;cache;compression;comp-req;comp-res;fcgi-app;spoe;trace;lua;
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["bwlim-in","bwlim-out","cache","compression","comp-req","comp-res","fcgi-app","spoe","trace","lua"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
