...
func TestPerformanceOptionsEqual(t *testing.T) {
	samples := []struct {
		a, b PerformanceOptions
	}{}
	for i := 0; i < 2; i++ {
...
func TestPerformanceOptionsEqualFalse(t *testing.T) {
	samples := []struct {
		a, b PerformanceOptions
	}{}
	for i := 0; i < 2; i++ {
...
func TestPerformanceOptionsDiff(t *testing.T) {
	samples := []struct {
		a, b PerformanceOptions
	}{}
	for i := 0; i < 2; i++ {
...
func TestPerformanceOptionsDiffFalse(t *testing.T) {
	samples := []struct {
		a, b PerformanceOptions
	}{}
	for i := 0; i < 2; i++ {
