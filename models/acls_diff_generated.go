...
func (x Acls) Diff(y Acls) map[string][]interface{} {
	return DiffAcls(x, y)
}

func DiffAcls(x, y Acls) map[string][]interface{} {
	...
	for i := 0; i < lenX && i < lenY; i++ {
		...
		for diffKey, diffValue := range DiffPointerACL(vx, vy) {
...
func DiffPointerACL(x, y *ACL) map[string][]interface{} {
	diff := make(map[string][]interface{})
	if x == nil && y == nil {
		return diff
	}
