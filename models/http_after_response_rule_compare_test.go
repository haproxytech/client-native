...
func TestHTTPAfterResponseRuleEqual(t *testing.T) {
	samples := []struct {
		a, b HTTPAfterResponseRule
	}{}
	for i := 0; i < 2; i++ {
		var sample HTTPAfterResponseRule
...
func TestHTTPAfterResponseRuleEqualFalse(t *testing.T) {
	samples := []struct {
		a, b HTTPAfterResponseRule
	}{}
	for i := 0; i < 2; i++ {
...
func TestHTTPAfterResponseRuleDiff(t *testing.T) {
	samples := []struct {
		a, b HTTPAfterResponseRule
	}{}
	for i := 0; i < 2; i++ {
...
func TestHTTPAfterResponseRuleDiffFalse(t *testing.T) {
	samples := []struct {
		a, b HTTPAfterResponseRule
	}{}
	for i := 0; i < 2; i++ {
	...
	for _, sample := range samples {
		...
		if len(result) != 24-1 {
			...
			t.Errorf("Expected HTTPAfterResponseRule to be different in 24 cases, but it is not (%d) %s %s", len(result), a, b)
		}
	}
}
