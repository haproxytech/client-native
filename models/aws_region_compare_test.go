...
func TestAwsRegionEqual(t *testing.T) {
	...
	for _, sample := range samples {
		...
		if !result {
			...
			t.Errorf("Expected AwsRegion to be equal, but it is not %s %s", a, b)
		}
	}
}
...
func TestAwsRegionEqualFalse(t *testing.T) {
	...
	for _, sample := range samples {
		...
		if result {
			...
			t.Errorf("Expected AwsRegion to be different, but it is not %s %s", a, b)
		}
	}
}
...
func TestAwsRegionDiff(t *testing.T) {
	...
	for _, sample := range samples {
		...
		if len(result) != 0 {
			...
			t.Errorf("Expected AwsRegion to be equal, but it is not %s %s, %v", a, b, result)
		}
	}
}
...
func TestAwsRegionDiffFalse(t *testing.T) {
	...
	for _, sample := range samples {
		...
		if len(listDiffFields) != 14 {
			...
			t.Errorf("Expected AwsRegion to be different in 14 cases, but it is not (%d) %s %s", len(result), a, b)
		}
	}
}
