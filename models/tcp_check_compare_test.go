...
func TestTCPCheckEqual(t *testing.T) {
	samples := []struct {
		a, b TCPCheck
	}{}
	for i := 0; i < 2; i++ {
...
func TestTCPCheckEqualFalse(t *testing.T) {
	samples := []struct {
		a, b TCPCheck
	}{}
	for i := 0; i < 2; i++ {
...
func TestTCPCheckDiff(t *testing.T) {
	samples := []struct {
		a, b TCPCheck
	}{}
	for i := 0; i < 2; i++ {
...
func TestTCPCheckDiffFalse(t *testing.T) {
	samples := []struct {
		a, b TCPCheck
	}{}
	for i := 0; i < 2; i++ {
